...
#   DS_TOP / DS_BOT         facet IDs for y=1 / y=0. Firedrake boundary markers differ across builds.
#                           If Nu is negative/NaN or dt collapses unexpectedly, set these (e.g. DS_BOT=3 DS_TOP=4 on Insomnia).
#
set -euo pipefail
